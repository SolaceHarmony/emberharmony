...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/SolaceHarmony/emberharmony/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for SolaceHarmony/emberharmony...\n")
...
console.log("Fetching npm all-time downloads for emberharmony...\n")
const npmDownloads = await fetchNpmDownloads("emberharmony")
