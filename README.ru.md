...
EmberHarmony является форком [opencode](https://github.com/anomalyco/opencode) от команды [SST](https://sst.dev). Мы глубоко благодарны за их основополагающую работу по созданию исключительного открытого ИИ-агента для написания кода. Этот проект развивает их видение и инженерные решения.
