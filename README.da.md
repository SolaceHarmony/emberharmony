...
CodeHarmony findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/SolaceHarmony/code-harmony/releases) eller [solace.ofharmony.ai/download](https://github.com/SolaceHarmony/code-harmony/releases).
...
Hvis du arbejder på et projekt der er relateret til CodeHarmony og bruger "opencode" som en del af navnet; f.eks. "opencode-dashboard" eller "opencode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af CodeHarmony-teamet og ikke er tilknyttet os på nogen måde.
...
**Bliv en del af vores community** [Discord](https://github.com/SolaceHarmony/code-harmony/discussions) | [X.com](https://github.com/SolaceHarmony/code-harmony)
