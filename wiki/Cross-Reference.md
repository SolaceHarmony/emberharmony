...
| `CN01` | ConditionProvider/ConditionFuser/BaseConditioner (moshi/conditioners/base.py) | `moshi/conditioners/base.py` | [moshi/conditioners/base.md](CN01-Conditioner-Base) |
| `CN02` | LUTConditioner (moshi/conditioners/text.py) | `moshi/conditioners/text.py` | [moshi/conditioners/text.md](CN02-Text-Conditioner) |
| `CN03` | TensorConditioner (moshi/conditioners/tensors.py) | `moshi/conditioners/tensors.py` | [moshi/conditioners/tensors.md](CN03-Tensor-Conditioner) |
| `MU01` | sample_token top-k/top-p multinomial (moshi/utils/sampling.py) | `moshi/utils/sampling.py` | [moshi/utils/sampling.md](MU01-Sampling) |
| `MU02` | CUDAGraphed + torch_compile gating (moshi/utils/compile.py) | `moshi/utils/compile.py` | [moshi/utils/compile.md](MU02-CUDA-Graphs) |
| `MU03` | TorchAutocast (moshi/utils/autocast.py) | `moshi/utils/autocast.py` | [moshi/utils/autocast.md](MU03-Autocast) |
| `MU04` | QLinear int8 weight-quantize helper (moshi/utils/quantize.py) | `moshi/utils/quantize.py` | [moshi/utils/quantize.md](MU04-Int8-Quantize) |
| `MU05` | cross_entropy (moshi/utils/utils.py) | `moshi/utils/utils.py` | [moshi/utils/utils.md](MU05-Moshi-Utils) |
| `TR01` | moshi_server (moshi/server.py) | `moshi/server.py` | [moshi/server.md](TR01-WS-Server) |
| `TR02` | moshi client (moshi/client.py) | `moshi/client.py` | [moshi/client.md](TR02-WS-Client) |
| `TR03` | AnyPrinter/RawPrinter/Printer (moshi/client_utils.py) | `moshi/client_utils.py` | [moshi/client_utils.md](TR03-Client-Utils) |
| `TR04` | moshi_run_inference (moshi/run_inference.py) | `moshi/run_inference.py` | [moshi/run_inference.md](TR04-Run-Inference) |
| `TR05` | moshi_run_tts (moshi/run_tts.py) | `moshi/run_tts.py` | [moshi/run_tts.md](TR05-Run-TTS) |
| `TR06` | MoshiHandler gradio WebRTC client (moshi/client_gradio.py) | `moshi/client_gradio.py` | [moshi/client_gradio.md](TR06-Gradio-Client) |
...
### `CN01` — ConditionProvider/ConditionFuser/BaseConditioner (moshi/conditioners/base.py)  ·  [moshi/conditioners/base.md](CN01-Conditioner-Base)
| Section | Python lines |
|---|---|
...
### `CN02` — LUTConditioner (moshi/conditioners/text.py)  ·  [moshi/conditioners/text.md](CN02-Text-Conditioner)
| Section | Python lines |
|---|---|
| RO | `text.py`:26 |
...
### `CN03` — TensorConditioner (moshi/conditioners/tensors.py)  ·  [moshi/conditioners/tensors.md](CN03-Tensor-Conditioner)
| Section | Python lines |
|---|---|
...
### `MU01` — sample_token top-k/top-p multinomial (moshi/utils/sampling.py)  ·  [moshi/utils/sampling.md](MU01-Sampling)
| Section | Python lines |
|---|---|
...
### `MU02` — CUDAGraphed + torch_compile gating (moshi/utils/compile.py)  ·  [moshi/utils/compile.md](MU02-CUDA-Graphs)
| Section | Python lines |
|---|---|
...
### `MU03` — TorchAutocast (moshi/utils/autocast.py)  ·  [moshi/utils/autocast.md](MU03-Autocast)
| Section | Python lines |
|---|---|
...
### `MU04` — QLinear int8 weight-quantize helper (moshi/utils/quantize.py)  ·  [moshi/utils/quantize.md](MU04-Int8-Quantize)
| Section | Python lines |
|---|---|
...
### `MU05` — cross_entropy (moshi/utils/utils.py)  ·  [moshi/utils/utils.md](MU05-Moshi-Utils)
| Section | Python lines |
|---|---|
...
### `TR01` — moshi_server (moshi/server.py)  ·  [moshi/server.md](TR01-WS-Server)
| Section | Python lines |
|---|---|
| HW | `server.py`:47-60,62-72,74-173 |

### `TR02` — moshi client (moshi/client.py)  ·  [moshi/client.md](TR02-WS-Client)
| Section | Python lines |
|---|---|
...
### `TR03` — AnyPrinter/RawPrinter/Printer (moshi/client_utils.py)  ·  [moshi/client_utils.md](TR03-Client-Utils)
| Section | Python lines |
|---|---|
| HW | `client.py`:185; `run_inference.py`:18,93 |
| WI | `client.py`:16; `run_inference.py`:18 |

### `TR04` — moshi_run_inference (moshi/run_inference.py)  ·  [moshi/run_inference.md](TR04-Run-Inference)
| Section | Python lines |
|---|---|
| HW | `run_inference.py`:66-95,121-127,128-135,138-202,164-170,171-174,175-201,196-201,208-217,220-315; `lm.py`:344-369 |

### `TR05` — moshi_run_tts (moshi/run_tts.py)  ·  [moshi/run_tts.md](TR05-Run-TTS)
| Section | Python lines |
|---|---|
| HW | `run_tts.py`:39-79,84-101,103-195,197-209 |

### `TR06` — MoshiHandler gradio WebRTC client (moshi/client_gradio.py)  ·  [moshi/client_gradio.md](TR06-Gradio-Client)
| Section | Python lines |
|---|---|
