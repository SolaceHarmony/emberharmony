...
| `reset_parameters_ff`/`reset_parameters_conv` (training-time init) | omitted | **deliberate omission** | the port loads pretrained weights via `VarBuilder`; empty re-init methods had no runtime meaning. |
