...
> Companion docs: [ARCHAEOLOGY.md](../liquid-audio-rs/ARCHAEOLOGY.md) (the 4 runtime questions),
> [ARCH_1_MIMI_CODEC.md](../liquid-audio-rs/ARCH_1_MIMI_CODEC.md) (the codec deep-dive),
> [PYTHON_VS_RUST.md](../liquid-audio-rs/PYTHON_VS_RUST.md) (deliberate port divergences).

> **Codes:** every node is tagged with its architecture code (e.g. `MD04`); the full code↔Python↔doc-section map is in [CROSSREF.md](CROSSREF.md).
...
flowchart TB
  ...
  click core_processor "processor.md"
  click conformer_processor "model/conformer/processor.md"
  click conformer_subsampling "model/conformer/subsampling.md"
  click conformer_encoder "model/conformer/encoder.md"
  click model_mlp "model/mlp.md"
  click model_lfm2_audio "model/lfm2_audio.md"
  click model_lfm2_backbone "model/lfm2_backbone.md"
  click model_transformer "model/transformer.md"
  click core_detokenizer "detokenizer.md"
  click moshi_compression "moshi/models/compression.md"
  click moshi_vq "moshi/quantization/vq.md"
  click moshi_seanet "moshi/modules/seanet.md"
...
> [model/conformer/](model/conformer/README.md) and [moshi/](moshi/README.md) for their
...
flowchart LR
  ...
  click core_processor "processor.md"
  click core_detokenizer "detokenizer.md"
  click core_utils "utils.md"
  click core_trainer "trainer.md"
  click model_lfm2_audio "model/lfm2_audio.md"
  click model_lfm2_backbone "model/lfm2_backbone.md"
  click model_mlp "model/mlp.md"
  click model_transformer "model/transformer.md"
  click conformer_encoder "model/conformer/encoder.md"
  click conformer_mha "model/conformer/mha.md"
  click conformer_modules "model/conformer/modules.md"
  click conformer_processor "model/conformer/processor.md"
  click conformer_subsampling "model/conformer/subsampling.md"
  click conformer_utils "model/conformer/utils.md"
  click data_dataloader "data/dataloader.md"
  click data_mapper "data/mapper.md"
  click data_preprocess "data/preprocess.md"
  click data_types "data/types.md"
  click moshi_compression "moshi/models/compression.md"
  click moshi_loaders "moshi/models/loaders.md"
  click moshi_lm "moshi/models/lm.md"
  click moshi_lm_utils "moshi/models/lm_utils.md"
  click moshi_tts "moshi/models/tts.md"
  click moshi_seanet "moshi/modules/seanet.md"
  click moshi_conv "moshi/modules/conv.md"
  click moshi_transformer "moshi/modules/transformer.md"
  click moshi_resample "moshi/modules/resample.md"
  click moshi_rope "moshi/modules/rope.md"
  click moshi_streaming "moshi/modules/streaming.md"
  click moshi_gating "moshi/modules/gating.md"
  click moshi_lora "moshi/modules/lora.md"
  click moshi_vq "moshi/quantization/vq.md"
  click moshi_core_vq "moshi/quantization/core_vq.md"
  click moshi_quant_base "moshi/quantization/base.md"
  click moshi_cond_base "moshi/conditioners/base.md"
  click moshi_cond_text "moshi/conditioners/text.md"
  click moshi_cond_tensors "moshi/conditioners/tensors.md"
  click moshi_util_sampling "moshi/utils/sampling.md"
  click moshi_util_compile "moshi/utils/compile.md"
  click moshi_util_autocast "moshi/utils/autocast.md"
  click moshi_util_quantize "moshi/utils/quantize.md"
  click moshi_util_utils "moshi/utils/utils.md"
  click moshi_server "moshi/server.md"
  click moshi_client "moshi/client.md"
  click moshi_client_utils "moshi/client_utils.md"
  click moshi_run_inference "moshi/run_inference.md"
  click moshi_run_tts "moshi/run_tts.md"
  click moshi_client_gradio "moshi/client_gradio.md"
  click demo_chat "demo/chat.md"
  click demo_model "demo/model.md"
  classDef onp fill:#0b3d2e,stroke:#19a974,color:#e8fff4,stroke-width:1px;
  classDef offp fill:#2a2a33,stroke:#6b7280,color:#cbd5e1,stroke-dasharray:4 3;```
...
|---|---|---|---|
| LFM2AudioProcessor + ChatState (processor.py) | wav f32 (1,L); text str; generated text int64  → ChatState bundle: text int64 (1,L), audio_in b | ✅ | [`processor.md`](processor.md) |
| LFM2AudioDetokenizer (detokenizer.py) | int64/int audio codes (1,8,T) values [0,2047] → f32 waveform (1,L) @ 24kHz | ✅ | [`detokenizer.md`](detokenizer.md) |
| core_utils (utils.py) | int/int64 mel widths; str repo id or Path; str → enum int 1/2/3 (materialized int64 (1,L) by ca | ✅ | [`utils.md`](utils.md) |

### model/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| LFM2AudioModel (model/lfm2_audio.py) | ChatState: text int64 (1,L_t); mel bf16 (128,Σ → stream of text id int64 (1,) and audio frame i | ✅ | [`model/lfm2_audio.md`](model/lfm2_audio.md) |
| Lfm2Model HF backbone (model/lfm2_audio.py imports transformers.Lfm2Model) | inputs_embeds model-dtype (bf16 cuda/Metal, f3 → last_hidden_state model-dtype (1,L,2048) post  | ✅ | [`model/lfm2_backbone.md`](model/lfm2_backbone.md) |
| MLP audio_adapter (model/mlp.py) | model dtype (bf16 GPU / f32 CPU), (ΣT',512) → model dtype (bf16/f32), (ΣT',2048) | ✅ | [`model/mlp.md`](model/mlp.md) |
| RawLMBackbone depthformer (model/transformer.py) | model dtype (bf16/f32) hidden [1,1,1024] per d → audio frame (8,) int codes 0..2048 (2048=EOAud | ✅ | [`model/transformer.md`](model/transformer.md) |

### model/conformer/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| ConformerEncoder (conformer/encoder.py) | model dtype (bf16/f32) mel features (B,128,T)  → model dtype (bf16/f32) audio_enc (B,512,T') +  | ✅ | [`model/conformer/encoder.md`](model/conformer/encoder.md) |
| RelPositionMultiHeadAttention + RelPositionalEncoding (model/conformer/mha.py) | model dtype (bf16 cuda / f32 Rust-CPU / bf16 M → model dtype, attention output (B,T',512); soft | ✅ | [`model/conformer/mha.md`](model/conformer/mha.md) |
| ConformerLayer/Convolution/FeedForward/CausalConv1D (model/conformer/modules.py) | model dtype (bf16 cuda / f32 CPU / bf16 Metal) → model dtype; (B,T',512) | ✅ | [`model/conformer/modules.md`](model/conformer/modules.md) |
| FilterbankFeatures mel front-end (model/conformer/processor.py) | f32 (1,L) mic PCM @16kHz → f32 mel (1,128,T) [T=1+L/160, padded to mult o | ✅ | [`model/conformer/processor.md`](model/conformer/processor.md) |
| ConvSubsampling (model/conformer/subsampling.py) | model dtype (bf16/f32) (B,T,128) mel features; → model dtype (bf16/f32) (B,T',512); int64 (B,)  | ✅ | [`model/conformer/subsampling.md`](model/conformer/subsampling.md) |
| conformer_utils (model/conformer/utils.py) | config scalars + autocast-dtype enum (no activ → context manager (autocast bf16/f32 or nullcont | ✅ | [`model/conformer/utils.md`](model/conformer/utils.md) |

### moshi/models/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| MimiModel codec (moshi/models/compression.py) | decode: int codes (B,8,T) values [0,2047] (Rus → decode: f32 waveform (B,1,T·1920)@24kHz · enco | ✅ | [`moshi/models/compression.md`](moshi/models/compression.md) |
| get_mimi factory + CheckpointInfo (moshi/models/loaders.py) | filename:Path/None, device, num_codebooks=8 (i → configured MimiModel (bf16/f32 weights); geome | ✅ | [`moshi/models/loaders.md`](moshi/models/loaders.md) |
| LMModel + LMGen (moshi/models/lm.py) | codes int64 [B, n_q+1, T] (train forward); LMG → LMOutput.logits model-dtype [B, dep_q, T, card | — | [`moshi/models/lm.md`](moshi/models/lm.md) |
| ScaledEmbedding + delay/init helpers (moshi/models/lm_utils.py) | int64 token ids (...,) for ScaledEmbedding; in → model-dtype (bf16/f32) embeddings (...,D); (un | — | [`moshi/models/lm_utils.md`](moshi/models/lm_utils.md) |
| TTSModel (moshi/models/tts.py) | script list[str] + voice safetensors speaker_w → TTSResult.frames: list of int64 [B,1+Q,1] (aco | — | [`moshi/models/tts.md`](moshi/models/tts.md) |

### moshi/modules/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| SEANetEncoder/Decoder (moshi/modules/seanet.py) | decoder: latent (B,512,t) model-dtype(bf16/f32 → decoder: waveform (B,1,t*960) f32 @24kHz; enco | ✅ | [`moshi/modules/seanet.md`](moshi/modules/seanet.md) |
| StreamingConv1d/ConvTranspose1d (moshi/modules/conv.py) | model dtype (bf16 cuda/Metal, f32 Rust CPU) (B → model dtype (B,C_out,T'); decoder transpose-co | ✅ | [`moshi/modules/conv.md`](moshi/modules/conv.md) |
| ProjectedTransformer/StreamingTransformer (moshi/modules/transformer.py) | model-dtype (bf16 cuda / f32 cpu) SEANet laten → model-dtype refined latent [B,512,T'] (conv_la | ✅ | [`moshi/modules/transformer.md`](moshi/modules/transformer.md) |
| ConvDownsample1d / ConvTrUpsample1d (moshi/modules/resample.py) | model dtype (CPU f32 / Metal bf16 / Python cud → model dtype, (B,512,T/2@12.5Hz) downsample-out | ✅ | [`moshi/modules/resample.md`](moshi/modules/resample.md) |
| RotaryEmbedding (moshi/modules/rope.py) | q/k: model dtype (bf16 cuda/Metal, f32 CPU) [B → qo/ko: model dtype (bf16/f32), rotated, [B,8,T | ✅ | [`moshi/modules/rope.md`](moshi/modules/rope.md) |
| StreamingModule[State] (moshi/modules/streaming.py) | no tensor input; allocates exec_mask bool (B,) → no tensor output; state tree {name: State} wit | ✅ | [`moshi/modules/streaming.md`](moshi/modules/streaming.md) |
| ActivationGating / make_gating (moshi/modules/gating.py) | model dtype (bf16 Metal/cuda, f32 Rust-CPU), ( → model dtype, (B,T,dim) | ✅ | [`moshi/modules/gating.md`](moshi/modules/gating.md) |
| LoRALinear (moshi/modules/lora.py) | bf16 (B,T,in_features); LoRA state_dict bf16 l → bf16 (B,T,out_features); merged weight bf16 (o | — | [`moshi/modules/lora.md`](moshi/modules/lora.md) |

### moshi/quantization/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| SplitResidualVectorQuantizer (moshi/quantization/vq.py) | latent (B,512,T) model dtype (bf16 cuda/metal, → codes (B,8,T) int64 values 0..2047 (encode); l | ✅ | [`moshi/quantization/vq.md`](moshi/quantization/vq.md) |
| EuclideanCodebook / ResidualVectorQuantization (moshi/quantization/core_vq.py) | decode: codes int (u32 in Rust) [n_q,B,T]; enc → decode: latent model-dtype (bf16 CUDA/Metal, f | ✅ | [`moshi/quantization/core_vq.md`](moshi/quantization/core_vq.md) |
| BaseQuantizer (moshi/quantization/base.py) | latent [B,512→256,T] model dtype (bf16 cuda /  → QuantizedResult{ x: latent [B,512,T] model dty | ✅ | [`moshi/quantization/base.md`](moshi/quantization/base.md) |

### demo/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| demo_chat (demo/chat.py) | mic audio (rate:int, np.ndarray int16-range) - → streamed: text token (1,) int64; audio code fr | — | [`demo/chat.md`](demo/chat.md) |
| demo singletons + CUDA warmup (demo/model.py) | HF_DIR str + snapshot weights (bf16 backbone m → three eval() singletons: proc (LFM2AudioProces | — | [`demo/model.md`](demo/model.md) |

### moshi/ (transport)

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| moshi_server (moshi/server.py) | Opus bytes over websocket -> sphn-decoded f32  → Opus audio bytes (ws x01) from f32 (1,1,1920) | — | [`moshi/server.md`](moshi/server.md) |
| moshi client (moshi/client.py) | f32 PCM (1920,1) mono @24kHz from PortAudio mi → ws binary b"x01"+opus (mic uplink) to server; | — | [`moshi/client.md`](moshi/client.md) |
| AnyPrinter/RawPrinter/Printer (moshi/client_utils.py) | str (decoded text token per LM step); level:st → str bytes to stdout (ANSI SGR-wrapped in Print | — | [`moshi/client_utils.md`](moshi/client_utils.md) |
| moshi_run_inference (moshi/run_inference.py) | f32 PCM (B,1,N) @ 24kHz (from sphn.read, broad → list[(text_tokens int64 (Ttok,), audio_tokens  | — | [`moshi/run_inference.md`](moshi/run_inference.md) |
| moshi_run_tts (moshi/run_tts.py) | JSONL str -> TTSRequest{turns:list[str], voice → f32 waveform (B,1,total_samples) @ 24kHz -> cl | — | [`moshi/run_tts.md`](moshi/run_tts.md) |
| MoshiHandler gradio WebRTC client (moshi/client_gradio.py) | f32 PCM (N,) @24kHz from mic (int16-scaled, /3 → tagged Opus bytes b"x01"+opus to server; f32  | — | [`moshi/client_gradio.md`](moshi/client_gradio.md) |

### data/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| LFM2DataLoader + lfm2_collator (data/dataloader.py) | Arrow columns per row: text int(→int64) (1,n), → LFM2AudioModelInput: text int64 (1,B·ctx), aud | — | [`data/dataloader.md`](data/dataloader.md) |
| LFM2AudioChatMapper (data/mapper.py) | list[ChatMessage] (str text + bytes audio) → LFM2AudioTrainingSample: text i64 (1,L_text);  | — | [`data/mapper.md`](data/mapper.md) |
| preprocess_dataset (data/preprocess.py) | LFM2AudioTrainingSample: text int64 (1,L), aud → HF Arrow dataset on disk: List&lt;List&lt;Int6 | — | [`data/preprocess.md`](data/preprocess.md) |
| data_types (data/types.py) | list[ChatMessage] (role + Text/Audio/Interleav → LFM2AudioModelInput bundle: text int64 (B,L);  | — | [`data/types.md`](data/types.md) |

### training

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| Trainer (trainer.py) | LFM2AudioModelInput batch: text int64 (B,L), a → f32 scalar loss (per step) + bf16 safetensors  | — | [`trainer.md`](trainer.md) |

### moshi/conditioners/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| ConditionProvider/ConditionFuser/BaseConditioner (moshi/conditioners/base.py) | ConditionAttributes (text str/None + TensorCon → ConditionType(condition model-dtype [B,T,outpu | — | [`moshi/conditioners/base.md`](moshi/conditioners/base.md) |
| LUTConditioner (moshi/conditioners/text.py) | list[str/None] (len B); after tokenize tokens  → ConditionType(condition model-dtype bf16/f32 [ | — | [`moshi/conditioners/text.md`](moshi/conditioners/text.md) |
| TensorConditioner (moshi/conditioners/tensors.py) | TensorCondition(tensor model-dtype/f32 [B/1,T, → ConditionType(condition model-dtype/f32 [B,T,D | — | [`moshi/conditioners/tensors.md`](moshi/conditioners/tensors.md) |

### moshi/utils/

| Component | dtype in → out | on-path | spec |
|---|---|---|---|
| sample_token top-k/top-p multinomial (moshi/utils/sampling.py) | f32 logits (…, Card) — Moshi callers upcast vi → int64 token id (…,) squeezed | — | [`moshi/utils/sampling.md`](moshi/utils/sampling.md) |
| CUDAGraphed + torch_compile gating (moshi/utils/compile.py) | passthrough: model-dtype (B,512,·) latent @25H → passthrough: wrapped module output unchanged — | ✅ | [`moshi/utils/compile.md`](moshi/utils/compile.md) |
| TorchAutocast (moshi/utils/autocast.py) | no tensor input — ctor args: enabled:bool + to → no tensor output — __enter__ returns None; amb | — | [`moshi/utils/autocast.md`](moshi/utils/autocast.md) |
| QLinear int8 weight-quantize helper (moshi/utils/quantize.py) | nn.Linear.weight bf16/f32 [out,in] (module tre → weight int8 [out,in] + weight_scb fp32 [out];  | — | [`moshi/utils/quantize.md`](moshi/utils/quantize.md) |
| cross_entropy (moshi/utils/utils.py) | logits bf16 [B,K,T,card]; targets int64 [B,K,T → ce f32 [B,K,T] (per-codebook, masked positions | — | [`moshi/utils/utils.md`](moshi/utils/utils.md) |

---

## Folder READMEs
- [model/](model/README.md) — the LFM2-Audio model graph
- [model/conformer/](model/conformer/README.md) — the FastConformer audio encoder
- [data/](data/README.md) — the training data pipeline
- [moshi/](moshi/README.md) — the Kyutai Moshi stack (codec on-path; LM + transport off-path)
- [moshi/models/](moshi/models/README.md) · [moshi/modules/](moshi/modules/README.md) ·
  [moshi/quantization/](moshi/quantization/README.md) ·
  [moshi/conditioners/](moshi/conditioners/README.md) · [moshi/utils/](moshi/utils/README.md)
- [demo/](demo/README.md) — realtime runtime + turn-taking
