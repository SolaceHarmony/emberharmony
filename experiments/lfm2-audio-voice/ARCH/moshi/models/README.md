...
flowchart TD
    ...
    click loaders "./loaders.md"
    click compression "./compression.md"
    click lm "./lm.md"
    click lm_utils "./lm_utils.md"
    click tts "./tts.md"
    click seanet "../modules/seanet.md"
    click xfmr "../modules/transformer.md"
    click resample "../modules/resample.md"
    click vq "../quantization/vq.md"
    click proc "../../processor.md"
    click mapper "../../data/mapper.md"
    click chat "../../demo/chat.md"
    click lfm2 "../../model/lfm2_audio.md"
```
