...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODE_HARMONY_CALLER", () => {
    process.env["CODE_HARMONY_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODE_HARMONY_CALLER", () => {
    process.env["CODE_HARMONY_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODE_HARMONY_CALLER", () => {
    process.env["CODE_HARMONY_CALLER"] = "unknown"
