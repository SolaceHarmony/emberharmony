...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/code-harmony.git")).toEqual({ owner: "sst", repo: "code-harmony" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/code-harmony")).toEqual({ owner: "sst", repo: "code-harmony" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/code-harmony.git")).toEqual({ owner: "sst", repo: "code-harmony" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/code-harmony")).toEqual({ owner: "sst", repo: "code-harmony" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/code-harmony.git")).toEqual({ owner: "sst", repo: "code-harmony" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/code-harmony")).toEqual({ owner: "sst", repo: "code-harmony" })
})
