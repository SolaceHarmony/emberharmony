import { Slug } from "@thesolaceproject/code-harmony-util/slug"
...
export namespace Session {
  ...
  export async function createNext(input: {
    ...
    if (!result.parentID && (Flag.CODE_HARMONY_AUTO_SHARE || cfg.share === "auto"))
      share(result.id)
        .then((share) => {
  ...
  export function plan(input: { slug: string; time: { created: number } }) {
    const base = Instance.project.vcs
      ? path.join(Instance.worktree, ".code-harmony", "plans")
