...
export function DialogModel(props: { providerID?: string }) {
  ...
  const options = createMemo(() => {
          ...
          return [
            {
              ...
              category: "Favorites",
              disabled: provider.id === "code-harmony" && model.id.includes("-nano"),
              footer: model.cost?.input === 0 && provider.id === "code-harmony" ? "Free" : undefined,
              onSelect: () => {
                dialog.clear()
                local.model.set(
                  {
    ...
    const providerOptions = pipe(
      sync.data.provider,
      sortBy(
        (provider) => provider.id !== "code-harmony",
        ...
        pipe(
          ...
          map(([model, info]) => {
            ...
            return {
              ...
              disabled: provider.id === "code-harmony" && model.includes("-nano"),
              footer: info.cost?.input === 0 && provider.id === "code-harmony" ? "Free" : undefined,
              onSelect() {
                dialog.clear()
                local.model.set(
                  {
