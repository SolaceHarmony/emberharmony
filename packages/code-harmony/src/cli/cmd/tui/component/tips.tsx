...
const TIPS = [
  ...
  "Create {highlight}code-harmony.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/code-harmony/code-harmony.json{/highlight} for global config",
  ...
  "CodeHarmony auto-handles OAuth for remote MCP servers requiring auth",
  "Add {highlight}.md{/highlight} files to {highlight}.code-harmony/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.code-harmony/agent/{/highlight} for specialized AI personas",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing',
  "CodeHarmony auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "CodeHarmony uses LSP servers for intelligent code analysis",
  "Create {highlight}.ts{/highlight} files in {highlight}.code-harmony/tool/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.code-harmony/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent CodeHarmony from reading sensitive files",
  "Use {highlight}code-harmony run{/highlight} for non-interactive scripting",
  "Use {highlight}code-harmony --continue{/highlight} to resume the last session",
  "Use {highlight}code-harmony run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}code-harmony serve{/highlight} for headless API access to CodeHarmony",
  "Use {highlight}code-harmony run --attach{/highlight} to connect to a running server",
  "Run {highlight}code-harmony upgrade{/highlight} to update to the latest version",
  "Run {highlight}code-harmony auth list{/highlight} to see all configured providers",
  "Run {highlight}code-harmony agent create{/highlight} for guided agent creation",
  "Use {highlight}/code-harmony{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}code-harmony github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/code-harmony fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.code-harmony/themes/{/highlight} directory",
  ...
  "Run {highlight}code-harmony debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/sydneyrenee/code-harmony{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with CodeHarmony Zen for curated, tested models",
