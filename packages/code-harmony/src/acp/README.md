...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for code-harmony.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal code-harmony sessions
...
code-harmony acp --cwd /path/to/project
```
...
- **Terminal Integration**: Full terminal support via code-harmony's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | code-harmony acp
```
...
### Mapping to CodeHarmony

ACP sessions map cleanly to code-harmony's internal session model:
