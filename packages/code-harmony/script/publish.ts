...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "url='https://github.com/sydneyrenee/code-harmony'",
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    ...
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/sydneyrenee/code-harmony/releases/download/v\${pkgver}\${_subver}/${cliName}-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/sydneyrenee/code-harmony/releases/download/v\${pkgver}\${_subver}/${cliName}-linux-x64.tar.gz")`,
  ...
  // Source-based PKGBUILD for code-harmony
  const sourcePkgbuild = [
    ...
    "",
    `source=("code-harmony-\${pkgver}.tar.gz::https://github.com/sydneyrenee/code-harmony/archive/v\${pkgver}\${_subver}.tar.gz")`,
    `sha256sums=('SKIP')`,
    "",
    "build() {",
    ...
    "",
    "package() {",
    `  cd "code-harmony-\${pkgver}/packages/code-harmony"`,
    ...
    "    fi",
    "  fi",
    `  bin="dist/code-harmony-linux-\${target_arch}\${base}\${libc}/bin/${cliName}"`,
    '  if [ ! -f "$bin" ]; then',
