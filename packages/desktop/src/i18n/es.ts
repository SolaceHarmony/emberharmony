export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de EmberHarmony",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de EmberHarmony. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message":
    "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'emberharmony'.",
  "desktop.cli.failed.title": "Instalación fallida",
  "desktop.cli.failed.message": "No se pudo instalar la CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "EmberHarmony no pudo iniciarse",
  "desktop.error.serverStartFailed.description":
    "No se pudo iniciar el servidor local de EmberHarmony. Reinicia la aplicación o revisa tu configuración de red (VPN/proxy) y vuelve a intentarlo.",
}
