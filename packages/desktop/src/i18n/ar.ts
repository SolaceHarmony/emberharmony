export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من CodeHarmony",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من CodeHarmony، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.cli.installed.message": "تم تثبيت CLI في {{path}}\n\nأعد تشغيل الطرفية لاستخدام الأمر 'code-harmony'.",
  "desktop.cli.failed.title": "فشل التثبيت",
  "desktop.cli.failed.message": "فشل تثبيت CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "فشل تشغيل CodeHarmony",
  "desktop.error.serverStartFailed.description":
    "تعذر بدء تشغيل خادم CodeHarmony المحلي. أعد تشغيل التطبيق، أو تحقق من إعدادات الشبكة (VPN/proxy) وحاول مرة أخرى.",
}
