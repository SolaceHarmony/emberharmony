...
pub mod x86_zoo; // x86-64 (AVX2 / AVX-512-BF16) sibling of the NEON zoo, with rayon fan-out
pub mod fanout; // CPU simulation of the GPU dispatch model (threadgroup grid + simdgroup barriers)
