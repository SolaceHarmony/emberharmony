...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders EMBERHARMONY_CALLER", () => {
    process.env["EMBERHARMONY_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode EMBERHARMONY_CALLER", () => {
    process.env["EMBERHARMONY_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown EMBERHARMONY_CALLER", () => {
    process.env["EMBERHARMONY_CALLER"] = "unknown"
