import { Slug } from "@thesolaceproject/emberharmony-util/slug"
...
export namespace Session {
  ...
  export async function createNext(input: {
    ...
    if (!result.parentID && (Flag.EMBERHARMONY_AUTO_SHARE || cfg.share === "auto"))
      share(result.id)
        .then((share) => {
  ...
  export function plan(input: { slug: string; time: { created: number } }) {
    const base = Instance.project.vcs
      ? path.join(Instance.worktree, ".emberharmony", "plans")
