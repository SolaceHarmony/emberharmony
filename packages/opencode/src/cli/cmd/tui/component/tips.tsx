...
const TIPS = [
  ...
  "Run {highlight}code-harmony serve{/highlight} for headless API access to OpenCode",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/SolaceHarmony/code-harmony{/highlight} for containerized use",
