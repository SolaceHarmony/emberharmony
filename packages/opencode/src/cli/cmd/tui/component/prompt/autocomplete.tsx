        ...
        >
          {(option, index) => (
            <box
              ...
              onMouseUp={() => select()}
            >
              <text fg={index === store.selected ? selectedForeground(theme, theme.primary) : theme.text} flexShrink={0}>
                {option().display}
              </text>
              <Show when={option().description}>
                <text
                  fg={index === store.selected ? selectedForeground(theme, theme.primary) : theme.textMuted}
                  wrapMode="none"
                >
                  {option().description}
                </text>
