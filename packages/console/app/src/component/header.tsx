...
import copyLogoSvgLight from "../asset/lander/code-harmony-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/code-harmony-logo-dark.svg"
import copyWordmarkSvgLight from "../asset/lander/code-harmony-wordmark-light.svg"
import copyWordmarkSvgDark from "../asset/lander/code-harmony-wordmark-dark.svg"
  ...
  return (
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href="/">
          <img data-slot="logo light" src={logoLight} alt="CodeHarmony logo light" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="CodeHarmony logo dark" width="189" height="34" />
        </A>
      </div>
