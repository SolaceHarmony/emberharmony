...
import { and, Database, eq, isNull } from "@thesolaceproject/code-harmony-console-core/drizzle/index.js"
...
import { BillingTable } from "@thesolaceproject/code-harmony-console-core/schema/billing.sql.js"
...
function Success(props: SuccessData) {
  return (
    <div data-slot="success">
      <p data-slot="title">You're on the CodeHarmony Black waitlist</p>
      <dl data-slot="details">
        <div>
          <dt>Subscription plan</dt>
          <dd>CodeHarmony Black {props.plan}</dd>
        </div>
        <div>
          <dt>Amount</dt>
...
export default function BlackSubscribe() {
  ...
  return (
    <>
      <Title>Subscribe to CodeHarmony Black</Title>
            ...
            <Match when={true}>
              <>
                <div data-slot="plan-header">
                  <p data-slot="title">Subscribe to CodeHarmony Black</p>
                  <p data-slot="price">
