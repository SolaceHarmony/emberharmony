---
title: TUI
description: Using the CodeHarmony terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeHarmony provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running CodeHarmony starts the TUI for the current directory.
...
When using the CodeHarmony TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to CodeHarmony. Allows you to select from available providers and add their API keys.
...
Exit CodeHarmony. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your CodeHarmony config file.
