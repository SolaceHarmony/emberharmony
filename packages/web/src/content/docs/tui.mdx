---
title: TUI
description: Using the EmberHarmony terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

EmberHarmony provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running EmberHarmony starts the TUI for the current directory.
...
When using the EmberHarmony TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to EmberHarmony. Allows you to select from available providers and add their API keys.
...
Exit EmberHarmony. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your EmberHarmony config file.
