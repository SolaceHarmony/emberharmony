...
Create `.emberharmony/commands/test.md`:

```md title=".emberharmony/commands/test.md"
---
...
You can add custom commands through the EmberHarmony config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your EmberHarmony [config](/docs/config):

```json title="emberharmony.jsonc" {4-12}
{
...
- Global: `~/.config/emberharmony/commands/`
- Per-project: `.emberharmony/commands/`

```markdown title="~/.config/emberharmony/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".emberharmony/commands/component.md"
---
...
```md title=".emberharmony/commands/create-file.md"
---
...
```md title=".emberharmony/commands/analyze-coverage.md"
---
...
```md title=".emberharmony/commands/review-changes.md"
---
...
```md title=".emberharmony/commands/review-component.md"
---
...
emberharmony includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
