...
Create `.code-harmony/commands/test.md`:

```md title=".code-harmony/commands/test.md"
---
...
You can add custom commands through the CodeHarmony config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your CodeHarmony [config](/docs/config):

```json title="code-harmony.jsonc" {4-12}
{
...
- Global: `~/.config/code-harmony/commands/`
- Per-project: `.code-harmony/commands/`

```markdown title="~/.config/code-harmony/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".code-harmony/commands/component.md"
---
...
```md title=".code-harmony/commands/create-file.md"
---
...
```md title=".code-harmony/commands/analyze-coverage.md"
---
...
```md title=".code-harmony/commands/review-changes.md"
---
...
```md title=".code-harmony/commands/review-component.md"
---
...
code-harmony includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
