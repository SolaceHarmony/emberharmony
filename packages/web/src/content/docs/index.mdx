...
- **Using Docker**
  ...
  ```bash
  docker run -it --rm ghcr.io/SolaceHarmony/code-harmony
  ```

Support for installing OpenCode on Windows using Bun is currently in progress.

You can also grab the binary from the [Releases](https://github.com/SolaceHarmony/code-harmony/releases).
