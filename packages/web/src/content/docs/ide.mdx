---
title: IDE
description: The EmberHarmony extension for VS Code, Cursor, and other IDEs
---

EmberHarmony integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `emberharmony` in the terminal to get started.
...
- **New Session**: Use `Cmd+Shift+Esc` (Mac) or `Ctrl+Shift+Esc` (Windows/Linux) to start a new EmberHarmony terminal session, even if one is already open. You can also click the EmberHarmony button in the UI.
...
To install EmberHarmony on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `emberharmony` - the extension installs automatically
...
Search for **EmberHarmony** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `emberharmony` in the integrated terminal.
