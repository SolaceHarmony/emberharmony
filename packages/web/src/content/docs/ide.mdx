---
title: IDE
description: The CodeHarmony extension for VS Code, Cursor, and other IDEs
---

CodeHarmony integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `code-harmony` in the terminal to get started.
...
- **New Session**: Use `Cmd+Shift+Esc` (Mac) or `Ctrl+Shift+Esc` (Windows/Linux) to start a new CodeHarmony terminal session, even if one is already open. You can also click the CodeHarmony button in the UI.
...
To install CodeHarmony on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `code-harmony` - the extension installs automatically
...
Search for **CodeHarmony** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `code-harmony` in the integrated terminal.
