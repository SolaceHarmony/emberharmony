...
description: What's new in EmberHarmony 1.0.
---

EmberHarmony 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same emberharmony server.
...
version. However some older versions of EmberHarmony always grab latest.

To upgrade manually, run

```bash
$ emberharmony upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ emberharmony upgrade 0.15.31
```
