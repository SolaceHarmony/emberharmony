...
description: What's new in CodeHarmony 1.0.
---

CodeHarmony 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same code-harmony server.
...
version. However some older versions of CodeHarmony always grab latest.

To upgrade manually, run

```bash
$ code-harmony upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ code-harmony upgrade 0.15.31
```
