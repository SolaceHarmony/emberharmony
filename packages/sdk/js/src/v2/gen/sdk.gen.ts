...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CodeHarmonyClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global CodeHarmony configuration settings and preferences.
   */
   ...
   *
   * Update global CodeHarmony configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the CodeHarmony server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the CodeHarmony system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all CodeHarmony instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with CodeHarmony.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that CodeHarmony is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by CodeHarmony.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current CodeHarmony configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update CodeHarmony configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all CodeHarmony sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new CodeHarmony session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific CodeHarmony session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current CodeHarmony instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the CodeHarmony system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the CodeHarmony system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the CodeHarmony system.
   */
...
export class CodeHarmonyClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CodeHarmonyClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    CodeHarmonyClient.__registry.set(this, args?.key)
  }
