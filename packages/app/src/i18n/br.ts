export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CodeHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CodeHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CodeHarmony.",
  ...
  "dialog.plugins.empty": "Plugins configurados em code-harmony.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CodeHarmony este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do CodeHarmony ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CodeHarmony",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (code-harmony.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CodeHarmony ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CodeHarmony",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o CodeHarmony aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CodeHarmony é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CodeHarmony iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CodeHarmony.",
