export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodeHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodeHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodeHarmony.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w code-harmony.json",
  ...
  "dialog.server.description": "Przełącz serwer CodeHarmony, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CodeHarmony ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CodeHarmony",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (code-harmony.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, CodeHarmony nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CodeHarmony",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CodeHarmony na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CodeHarmony.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodeHarmony",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodeHarmony.",
