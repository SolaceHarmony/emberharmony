export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CodeHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CodeHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CodeHarmony.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i code-harmony.json",
  ...
  "dialog.server.description": "Skift hvilken CodeHarmony-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af CodeHarmony ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CodeHarmony-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (code-harmony.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, CodeHarmony understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CodeHarmony",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CodeHarmony ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CodeHarmony er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CodeHarmony starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CodeHarmony.",
