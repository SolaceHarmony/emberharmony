export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af EmberHarmony",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i EmberHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "EmberHarmony Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.harmonyZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.harmonyZen.visit.prefix": "Besøg ",
  "provider.connect.harmonyZen.visit.link": "solace.ofharmony.ai/zen",
  "provider.connect.harmonyZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i EmberHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i EmberHarmony.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i emberharmony.json",
  ...
  "dialog.server.description": "Skift hvilken EmberHarmony-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af EmberHarmony ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til EmberHarmony-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (emberharmony.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, EmberHarmony understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "EmberHarmony inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for EmberHarmony",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan EmberHarmony ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan EmberHarmony er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når EmberHarmony starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af EmberHarmony.",
