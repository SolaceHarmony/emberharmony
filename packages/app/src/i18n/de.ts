...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in CodeHarmony zu nutzen.",
  ...
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in CodeHarmony zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in CodeHarmony zu nutzen.",
  ...
  "dialog.plugins.empty": "In code-harmony.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den CodeHarmony-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von CodeHarmony ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CodeHarmony-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (code-harmony.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CodeHarmony unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CodeHarmony Desktop",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CodeHarmony ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie CodeHarmony auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CodeHarmony anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CodeHarmony automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von CodeHarmony.",
