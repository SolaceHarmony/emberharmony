export const dict = {
  ...
  "dialog.provider.emberharmony.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by EmberHarmony",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in EmberHarmony.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.harmonyZen.line1":
    "EmberHarmony Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.harmonyZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.harmonyZen.visit.prefix": "Visit ",
  "provider.connect.harmonyZen.visit.link": "solace.ofharmony.ai/zen",
  "provider.connect.harmonyZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in EmberHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in EmberHarmony.",
  ...
  "voice.disconnect": "Stop voice mode",
  "voice.error": "Voice error",
  "voice.toast.connectFailed.title": "Failed to start voice mode",
  "voice.transcript.you": "You",
  "voice.transcript.agent": "Agent",
  ...
  "settings.voice.row.apiSecret.title": "API secret",
  "settings.voice.row.credentials.description": "Stored in the local credentials store, never in config files",
  "settings.voice.row.stt.title": "Speech to text",
  "settings.voice.row.stt.description": "Transcribes what you say",
  "settings.voice.row.tts.title": "Text to speech",
  "settings.voice.row.tts.description": "The assistant's voice",
  "settings.voice.row.intent.title": "Intent model",
  "settings.voice.row.intent.description": "Small fast model that routes spoken turns between plan and build",
  "settings.voice.action.save": "Save connection",
  "settings.voice.action.test": "Test connection",
  "settings.voice.toast.saved": "Voice settings saved",
  "settings.voice.toast.saveFailed": "Failed to save voice settings",
  ...
  "settings.voice.toast.speakerOk": "Speaker output works",
  "settings.voice.toast.speakerReport": "{{device}}, {{rate}} Hz, {{frames}} WebRTC frames, ADM {{adm}}",
  "settings.voice.toast.speakerFailed": "Speaker output test failed",
  ...
  "settings.voice.row.provider.title": "Provider",
  "settings.voice.row.provider.description": "How voice runs — a local on-device model, or LiveKit in the cloud",
  "settings.voice.row.speaker.title": "Speaker output",
  "settings.voice.row.speaker.description": "Native playback path used by desktop voice",
  "settings.voice.audioStats":
    "Audio decoded {{decoded}}, queued {{queued}}, played {{played}}, dropped {{dropped}}, underruns {{underruns}}",
  "settings.voice.engine.lfm2Interleaved": "Runtime: LFM2-Audio interleaved turn loop",
  "settings.voice.engine.moshiRealtime": "Runtime: Moshi frame-realtime loop",
  "settings.voice.engineOption.lfm2Interleaved": "LFM2 interleaved",
  "settings.voice.engineOption.moshiRealtime": "Moshi realtime",
  "settings.voice.provider.off": "Off",
  "settings.voice.provider.lfm2": "Local",
  "settings.voice.provider.livekit": "LiveKit",
  "settings.voice.section.lfm2": "Local voice model",
  "settings.voice.row.engine.title": "Local engine",
  "settings.voice.row.engine.description": "Native model loop used by Local voice and the desktop LiveKit agent",
  "settings.voice.row.model.title": "Model",
  "settings.voice.row.model.description":
    "The default works out of the box - change it only to use a fork or a newer version.",
  "settings.voice.row.moshiModel.description":
    "Realtime Moshi model source. The default follows the vendored Liquid Audio server.",
  "settings.voice.row.model.viewOnHf": "View on Hugging Face ↗",
  "settings.voice.row.modelDir.title": "Local snapshot directory",
  "settings.voice.row.modelDir.description": "Optional folder containing config.json, weights, and tokenizer files",
  "settings.voice.row.moshiModelDir.description":
  ...
  "settings.voice.section.mode.tts": "Text-to-speech decoding",
  "settings.voice.section.mode.asr": "Transcription decoding (ASR)",
  "settings.voice.row.maxTokens.title": "Max tokens per turn",
  "settings.voice.row.maxTokens.description": "Upper bound on the reply length — every audio frame costs one token",
  "settings.voice.row.textTemperature.title": "Text temperature",
  "settings.voice.row.textTemperature.description": "Sampling temperature for reply text (0 = greedy)",
  "settings.voice.row.textTopK.title": "Text top-k",
  "settings.voice.row.textTopK.description": "Restrict text sampling to the k most likely tokens (0 = no cutoff)",
  "settings.voice.row.audioTemperature.title": "Audio temperature",
  "settings.voice.row.audioTemperature.description": "Sampling temperature for speech audio (0 = greedy, which garbles speech)",
  "settings.voice.row.audioTopK.title": "Audio top-k",
  "settings.voice.row.audioTopK.description": "Restrict audio sampling to the k most likely tokens (0 = no cutoff)",
  "settings.voice.row.revision.title": "Model version",
  "settings.voice.row.revision.description": "Optional branch, tag, or commit to download (default branch if blank)",
  "settings.voice.row.hfToken.title": "Hugging Face token",
  "settings.voice.row.hfToken.description": "Stored in your OS keychain — needed only for gated or private models",
  "settings.voice.row.hfToken.stored": "Token stored",
  "settings.voice.row.modelDir.browse": "Browse…",
  "settings.voice.action.download": "Download model",
  "settings.voice.action.saveToken": "Save token",
  "settings.voice.action.testSpeaker": "Test speaker",
  "settings.voice.action.testingSpeaker": "Testing...",
  "settings.voice.download.downloading": "Downloading",
  "settings.voice.download.done": "Model downloaded",
  "settings.voice.download.failed": "Download failed",
  "settings.voice.section.delegate": "Delegation",
  "settings.voice.row.delegate.title": "Delegate hard work",
  "settings.voice.row.delegate.description": "When the local model emits DELEGATE, hand the task to a bigger model",
  "settings.voice.row.delegateTarget.title": "Delegate target",
  "settings.voice.row.delegateTarget.description": "Model the delegated task runs on, e.g. a GLM model id",
  "settings.voice.lfm2.desktopOnly": "The local model runs natively in the desktop app.",
  "settings.voice.off.hint": "Voice is off. Pick a provider above to set it up.",
  ...
  "dialog.server.description": "Switch which EmberHarmony server this app connects to.",
  ...
  "toast.update.description": "A new version of EmberHarmony ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the EmberHarmony team",
  ...
  "error.chain.checkConfig": "Check your config (emberharmony.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, EmberHarmony does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "EmberHarmony includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",

  "app.name.desktop": "EmberHarmony Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for EmberHarmony",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how EmberHarmony looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how EmberHarmony is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when EmberHarmony launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of EmberHarmony.",
