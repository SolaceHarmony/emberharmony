export const dict = {
  ...
  "settings.voice.provider.lfm2": "Local (LFM2-Audio)",
  "settings.voice.provider.livekit": "LiveKit",
  "settings.voice.section.lfm2": "Local model (LFM2-Audio)",
  "settings.voice.row.model.title": "Model",
  "settings.voice.row.model.description": "The default works out of the box — change it only to use a fork or a newer version.",
