export const dict = {
  ...
  "dialog.provider.code-harmony.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CodeHarmony.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CodeHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CodeHarmony.",
  ...
  "dialog.plugins.empty": "Plugins configured in code-harmony.json",
  ...
  "dialog.server.description": "Switch which CodeHarmony server this app connects to.",
  ...
  "toast.update.description": "A new version of CodeHarmony ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CodeHarmony team",
  ...
  "error.chain.checkConfig": "Check your config (code-harmony.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CodeHarmony does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for CodeHarmony",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CodeHarmony looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CodeHarmony is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CodeHarmony launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CodeHarmony.",
