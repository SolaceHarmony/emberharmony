export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CodeHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CodeHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CodeHarmony.",
  ...
  "dialog.plugins.empty": "Plugins configurados en code-harmony.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de CodeHarmony se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de CodeHarmony ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de CodeHarmony",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (code-harmony.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, CodeHarmony no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CodeHarmony",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve CodeHarmony en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CodeHarmony.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CodeHarmony",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CodeHarmony.",
