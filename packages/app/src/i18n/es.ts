export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por EmberHarmony",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en EmberHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "EmberHarmony Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.harmonyZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.harmonyZen.visit.prefix": "Visita ",
  "provider.connect.harmonyZen.visit.link": "solace.ofharmony.ai/zen",
  "provider.connect.harmonyZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en EmberHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en EmberHarmony.",
  ...
  "dialog.plugins.empty": "Plugins configurados en emberharmony.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de EmberHarmony se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de EmberHarmony ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de EmberHarmony",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (emberharmony.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, EmberHarmony no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "EmberHarmony incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para EmberHarmony",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve EmberHarmony en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de EmberHarmony.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia EmberHarmony",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de EmberHarmony.",
