...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av EmberHarmony",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i EmberHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "EmberHarmony Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.harmonyZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.harmonyZen.visit.prefix": "Besøk ",
  "provider.connect.harmonyZen.visit.link": "solace.ofharmony.ai/zen",
  "provider.connect.harmonyZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i EmberHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i EmberHarmony.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i emberharmony.json",
  ...
  "dialog.server.description": "Bytt hvilken EmberHarmony-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av EmberHarmony ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til EmberHarmony-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (emberharmony.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at EmberHarmony ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "EmberHarmony inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for EmberHarmony",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan EmberHarmony ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan EmberHarmony er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når EmberHarmony starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av EmberHarmony.",
