...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CodeHarmony",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CodeHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "CodeHarmony Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CodeHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CodeHarmony.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i code-harmony.json",
  ...
  "dialog.server.description": "Bytt hvilken CodeHarmony-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CodeHarmony ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CodeHarmony-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (code-harmony.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CodeHarmony ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CodeHarmony",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CodeHarmony ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CodeHarmony er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CodeHarmony starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CodeHarmony.",
