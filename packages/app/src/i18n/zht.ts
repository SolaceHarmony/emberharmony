...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "CodeHarmony 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 CodeHarmony 中使用 {{provider}} 模型。",
  ...
  "provider.connect.harmonyZen.line1": "CodeHarmony Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 CodeHarmony 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 CodeHarmony 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 code-harmony.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 CodeHarmony 伺服器。",
  ...
  "toast.update.description": "CodeHarmony 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 CodeHarmony 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (code-harmony.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: CodeHarmony 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "CodeHarmony 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 CodeHarmony 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 CodeHarmony 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 CodeHarmony 的主題。",
  ...
  "settings.updates.row.startup.description": "在 CodeHarmony 啟動時自動檢查更新",
