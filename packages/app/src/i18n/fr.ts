export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par EmberHarmony",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans EmberHarmony.",
  ...
  "provider.connect.harmonyZen.line1":
    "EmberHarmony Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.harmonyZen.visit.prefix": "Visitez ",
  "provider.connect.harmonyZen.visit.link": "solace.ofharmony.ai/zen",
  "provider.connect.harmonyZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans EmberHarmony.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans EmberHarmony.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans emberharmony.json",
  ...
  "dialog.server.description": "Changez le serveur EmberHarmony auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'EmberHarmony ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe EmberHarmony",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (emberharmony.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'EmberHarmony ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "EmberHarmony inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour EmberHarmony",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'EmberHarmony sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'EmberHarmony.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'EmberHarmony",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'EmberHarmony.",
