...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@thesolaceproject/code-harmony-ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(() => {
    const run = async () => {
      ...
      if (window.__CODE_HARMONY__?.serverPassword) {
        url.username = "code-harmony"
        url.password = window.__CODE_HARMONY__?.serverPassword
      }
