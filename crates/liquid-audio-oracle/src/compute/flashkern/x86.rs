...
//!
//! BF16 GEMM dispatch and ownership live in [`crate::flashkern::native_engine`]. This module
//! exposes only the auxiliary architecture-specific SIMD leaves and CPU feature probe.
//!
