...
LFM_INTERNAL_API int lfm_detokenizer_plan_new_from_image(
    LfmAudioDetokenizerPlan **out, const LfmWeightImage *image, char *error,
    size_t error_length);
LFM_INTERNAL_API void
...
LFM_INTERNAL_API uint64_t lfm_detokenizer_plan_compatibility_copied_bytes(
...
LFM_INTERNAL_API int lfm_detokenizer_state_new(
