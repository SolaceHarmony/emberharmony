...
nix run nixpkgs#code-harmony           # 또는 github:SolaceHarmony/code-harmony 로 최신 dev 브랜치
```
...
CodeHarmony 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/SolaceHarmony/code-harmony/releases) 에서 직접 다운로드하거나 [solace.ofharmony.ai/download](https://github.com/SolaceHarmony/code-harmony/releases) 를 이용하세요.
...
[agents](https://solace.ofharmony.ai/docs/agents) 에 대해 더 알아보세요.
...
CodeHarmony 와 관련된 프로젝트를 진행하면서 이름에 "opencode"(예: "opencode-dashboard" 또는 "opencode-mobile") 를 포함한다면, README 에 해당 프로젝트가 CodeHarmony 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.
...
**커뮤니티에 참여하기** [Discord](https://github.com/SolaceHarmony/code-harmony/discussions) | [X.com](https://github.com/SolaceHarmony/code-harmony)
